$(document).ready(function(){
    ...
    // Style Switcher 
    $('#style-demo-switcher').animate({
      left: '-150px'
    });

    $('#style-demo-switcher h4 a').click(function(e){
      e.preventDefault();
      var div = $('#style-demo-switcher');
    ...
    $(".style-sheet-1" ).click(function(){
      $("#styleType" ).attr("href", "assets/css/color-css/brown.css" );
      return false;
    });

    $(".style-sheet-2" ).click(function(){
      $("#styleType" ).attr("href", "assets/css/color-css/blue.css" );
      return false;
    });

    $(".style-sheet-3" ).click(function(){
      $("#styleType" ).attr("href", "assets/css/color-css/green.css" );
      return false;
    });

    $(".style-sheet-4" ).click(function(){
      $("#styleType" ).attr("href", "assets/css/color-css/indigo.css" );
      return false;
    });

    $(".style-sheet-5" ).click(function(){
      $("#styleType" ).attr("href", "assets/css/color-css/pink.css" );
      return false;
    });

    $(".style-sheet-6" ).click(function(){
      $("#styleType" ).attr("href", "assets/css/color-css/red.css" );
      return false;
    });
